...
export const ESSENCE_UPGRADE_ICONS: Record<EssenceUpgradeId, string> = {
  ...
  // Arcanist batch 2, as listed in Icon-ref-links.txt.
  regenRespawn: icon('Essence_Regeneration_Reduction.png'),
  superShinyChance1: icon('Super_Shiny_Essence_Chance.png'),
  flatDamageWeakenNegate: icon('Weaken_Negate_Chance.png'),
  allMaxLoot: icon('All_Essence_Max_Loot.png'),
  damagePctBrittle: icon('Brittle_Essence_Chance.png'),
  superShinyLoot: icon('Super_Shiny_Essence_Multi.png'),
  critChanceUltraCrit: icon('Pickaxe_Ultra_Crit_Chance.png'),
  critDamageAttackSpeed: icon('Pickaxe_Crit_Damage.png'),
  allMinLoot: icon('All_Essence_Min_Loot.png'),
  flatDamageDebuffNegate: icon('All_Debuff_Negate_Chance.png'),
  critChanceRespawn: icon('Pickaxe_Crit_Chance.png'),
  superCritDamageDazeNegate: icon('Dazed_Negate_Chance.png'),
  shinyChanceUltraShiny: icon('Ultra_Shiny_Essence_Chance.png'),
  allShinyLoot: icon('All_Shiny_Essence_Loot.png'),
  damagePctArmorPen: icon('Obelisk_Armor_Reduction.png'),
  superCritDamageStunNegate: icon('Stun_Negate_Chance.png'),
  flatDamageSuperCrit: icon('Pickaxe_Super_Crit_Chance.png'),
  critDamageUltraCrit: icon('Pickaxe_Ultra_Crit_Chance.png'),
  superShinyChanceAttackSpeed: icon('Super_Shiny_Essence_Chance.png'),
};
...
export const UNLOCK_ICONS = {
  ...
  spellslingerBundle: icon('Spellslinger_VP.png'),
